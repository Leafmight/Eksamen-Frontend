...
const FindFlight = ({ flightinfo }) => {
  ...
  return (
    <div>
      <form>
        <input type="name" name="destination" placeholder="Destination"onChange={handleFindFlight} />
        <input type="date" name="startDate" placeholder="Destination" onChange={handleFindFlight} />
        <input type="date" name="departure" placeholder="Departure" onChange={handleFindFlight} />
        <input type="number" name="adults" placeholder="quantity" onChange={handleFindFlight} />
