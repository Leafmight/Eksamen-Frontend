  ...
  return (
    <Switch>
      ...
      <Route path="/flightinfo">
        <FlightData flightinfo={props.flightinfo} />
      </Route>
      <Route path="*">
        <NoMatch />
      </Route>
...
const Home = () => {
  return (
    <div>
      ...
      <form>
        <input type="text" placeholder="Destination" id="desti"/>
        <input type="text" placeholder="Departure" id="depart"/>
...
function handleChangeFindFlight(event){
