    ...
    <div>
      <form>
       { /*<input type="text" name="departure" placeholder="Departure" onChange={handleFindFlight} />*/}
        ...
        <input type=text  data-date-format='yy-mm-dd' onChange={handleFindFlight} /> 
        <input type="date" data-provide="datepicker" name="startDate" data-date-format="yyyy-mm-dd" onChange={handleFindFlight} placeholder="Select date" required/>
