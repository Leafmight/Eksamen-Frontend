...
const FindFlight = ({ flightinfo }) => {
  ...
  function handleSubmit(event) {
    ...
    setState({
      ...flightinfo.fetchFlightData1(facade.fetchFlightData1(state.departure, state.destination, state.startDate, state.adults, state.cabinClass))
    });
  }
