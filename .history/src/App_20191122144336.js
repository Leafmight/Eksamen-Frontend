    ...
    <div>
      <form>
        ...
        <select name="cabinClass">
          <option  name="cabinClass" value="Economy">
            Economy
          </option>
          <option  name="cabinClass" value="Premium Economy">
            Premium Economy
          </option>
          <option  name="cabinClass" value="Business">
            Business
          </option>
          <option name="cabinClass" value="First Class">
            First Class
          </option>
        </select>
