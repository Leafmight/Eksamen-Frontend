  ...
  return (
    <div>
      <form>
        ...
        <input type="text" name="startDate" id="datepicker" onChange={handleFindFlight} required/>
        <Moment format="YYYY/MM/DD"><input type="number" name="adults" placeholder="1" min="1" size="4" onChange={handleFindFlight} /></Moment>
